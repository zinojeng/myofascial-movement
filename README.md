...
| | |
|---|---|
| 章節 | 9（基礎與立場 3 + 方法與練習 3 + 部位與整合 3） |
| 單元 | 27（17 個實作主題、4 個觀念、4 個迷思查核、1 個課表、1 個說明） |
| 影片 | 105 支示範 + 27 堂中文主課 + 27 堂英文對照＝159 個欄位、151 支不重複、91 個頻道 |
| 課程時長 | **12 小時 13 分**（英文對照版全看過則為 16 小時 44 分） |
| 內容角色 | 159/159 已標註 · 科學與理論 22% · 教練／治療師實務 43% · 純示範 23% · 爭議觀點 2% |
| 字幕 | 151 支中 27 支有人工字幕、106 支至少有自動字幕、**45 支完全沒有**（幾乎全是中文頻道） |
| 實證查核 | 22 個單元層級 + 11 個介入類別＝33 條判定 |
| 文獻 | 130 筆結構化引用（103 個不重複 PMID），另有 131 個 PMID 直接寫在論述裡 |
| 科學證據 | 證據較充分 **0** · 中等 16 · 有限 14 · 存在爭議 3 |
| 驗證 | 稽核零錯誤零警告、連結 151/151 有效、引用 130/130 標題相符、散文 PMID 131/131 存在 |

查證結果沒有很好看，而這正是重點：

- **33 條實證判定裡沒有任何一條拿到「證據較充分」**
