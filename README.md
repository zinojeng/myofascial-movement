...
**二、連結真的活著。** 一百多個格子最大的風險是連結是捏造的，所以有兩層關卡：
...
**三、每個動作都有停止條件。** 每一支示範影片的 `dose` 都寫了三件事：
...
| 影片 | 105 支示範 + 27 堂主課＝132 個欄位、124 支不重複、76 個頻道 |
| 課程時長 | **12 小時 13 分** |
| 實證查核 | 22 個單元層級 + 11 個介入類別＝33 條判定 |
| 文獻 | 130 筆結構化引用（103 個不重複 PMID），另有 131 個 PMID 直接寫在論述裡 |
| 證據分級 | 證據充分 **0** · 中等 16 · 有限 14 · 互斥 3 |
| 驗證 | 稽核零錯誤零警告、連結 124/124 有效、引用 130/130 標題相符、散文 PMID 131/131 存在 |

查證結果沒有很好看，而這正是重點：

- **33 條實證判定裡沒有任何一條拿到「證據充分」**
